...
/**
 * Команда показа всех работников.
 */
public class ShowCommand implements ClientCommand {
    ...
    public ShowCommand(Client client, ClientConsole console) {
        this.client = client;
    ...
    public void execute(String args) {
        Response response = client.sendRequest(new Request("show", null));
        if (response.isSuccess() && response.getData() instanceof List) {
            console.printWorkersList((List<Worker>) response.getData());
        } else {
